package com.edu.bearjay.dongbao.generator;
...
public class DongbaoGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("F:\\workspace\\bearjay-dongbao-mall-parent-v1\\bearjay-dongbao-service\\bearjay-dongbao-ums\\src\\main\\java");
        gc.setAuthor("bearjay");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/bearjay_dongbao_mall?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("lang*123456");
        ...
        pc.setParent("com.edu.bearjay.dongbao.ums");
        pc.setEntity("entity");
        pc.setMapper("mapper");
